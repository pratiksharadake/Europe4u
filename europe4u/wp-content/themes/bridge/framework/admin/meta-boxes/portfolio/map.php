...
//	$qode_portfolio_image_galery_orientation = new QodeMetaField("select","qode_portfolio_gallery_image_orientation","image_landscape","Image Orientation","Choose image orientation for Portfolio Gallery type",array(
//		"full" => "Original Size",
