...
$qodeFramework->qodeMetaBoxes->addMetaBox("slides_title",$qodeSlideTitle);
	...
	$qodeSlideTitle->addChild("title_group",$title_group);
	    ...
	    $title_group->addChild("row3",$row3);
		    ...
		    $title_background_color_transparency = new QodeField("textsimple","qode_slide-title-bg-color-transparency","","Background Color Transparency (0 = fully transparent, 1 = opaque)","Value between 0 and 1");
