...
<?php if(!empty($qode_options_proya['dropdown_wide_color']) || !empty($qode_options_proya['dropdown_wide_fontsize']) || !empty($qode_options_proya['dropdown_wide_lineheight']) || !empty($qode_options_proya['dropdown_wide_fontstyle']) || !empty($qode_options_proya['dropdown_wide_fontweight']) || $qode_options_proya['dropdown_wide_google_fonts'] != "-1" || !empty($qode_options_proya['dropdown_wide_texttransform'])  || (isset($qode_options_proya['dropdown_wide_letterspacing']) && $qode_options_proya['dropdown_wide_letterspacing'] !== '')){ ?>
	...
	<?php if ($qode_options_proya['dropdown_wide_letterspacing'] !== '') { ?> letter-spacing: <?php echo $qode_options_proya['dropdown_wide_letterspacing'];  ?>px;  <?php } ?>
	}
<?php } ?>
...
<?php if($qode_options_proya['page_title_position'] != "0"){ ?>
.title .separator{
	text-align: <?php if($qode_options_proya['page_title_position'] == "1"){echo "left";} if($qode_options_proya['page_title_position'] == "2"){echo "center";} if($qode_options_proya['page_title_position'] == "3"){echo "right";}  ?>;
	<?php if($qode_options_proya['page_title_position'] == "1" || $qode_options_proya['page_title_position'] == "3"){?>
		margin-left:0;
		margin-right:0;
...
<?php if (!empty($qode_options_proya['button_title_color'])) { ?>	color: <?php echo $qode_options_proya['button_title_color'];  ?>; <?php } ?>
	...
	<?php if ($qode_options_proya['button_border_radius'] !== '') { ?>	border-radius: <?php echo $qode_options_proya['button_border_radius'];  ?>px; <?php } ?>
	<?php if ($qode_options_proya['button_border_radius'] !== '') { ?>	-moz-border-radius: <?php echo $qode_options_proya['button_border_radius'];  ?>px; <?php } ?>
	<?php if ($qode_options_proya['button_border_radius'] !== '') { ?>	-webkit-border-radius: <?php echo $qode_options_proya['button_border_radius'];  ?>px; <?php } ?>
	<?php if ($qode_options_proya['button_title_letter_spacing'] !== '') { ?>	letter-spacing: <?php echo $qode_options_proya['button_title_letter_spacing'];  ?>px; <?php } ?>
	<?php if($qode_options_proya['button_border_width'] !== '') { ?> border-width: <?php echo $qode_options_proya['button_border_width']; ?>px;<?php } ?>
}
<?php } ?>
...
<?php if (!empty($qode_options_proya['small_button_fontsize']) || !empty($qode_options_proya['small_button_lineheight']) || !empty($qode_options_proya['small_button_fontweight']) || !empty($qode_options_proya['small_button_padding']) || !empty($qode_options_proya['small_button_border_radius'])) { ?>
	...
	<?php if (!empty($qode_options_proya['small_button_border_radius'])) { ?>	border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['small_button_border_radius'])) { ?>	-moz-border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>
	<?php if (!empty($qode_options_proya['small_button_border_radius'])) { ?>	-webkit-border-radius: <?php echo $qode_options_proya['small_button_border_radius'];  ?>px; <?php } ?>
...
<?php if (!empty($qode_options_proya['counter_color']) ||
	...
	<?php if($qode_options_proya['counters_font_size'] !== '') { ?> font-size: <?php echo $qode_options_proya['counters_font_size']; ?>px; <?php } ?>
	<?php if($qode_options_proya['counters_font_family'] !== '-1') { ?> font-family: '<?php echo str_replace('+', ' ', $qode_options_proya['counters_font_family']); ?>'; <?php } ?>
...
<?php if (!empty($qode_options_proya['vertical_menu_color']) || !empty($qode_options_proya['vertical_menu_fontsize']) || !empty($qode_options_proya['vertical_menu_fontstyle']) || !empty($qode_options_proya['vertical_menu_lineheight']) || !empty($qode_options_proya['vertical_menu_fontweight']) || !empty($qode_options_proya['vertical_menu_letter_spacing']) || $qode_options_proya['vertical_menu_google_fonts'] != "-1") { ?>
	nav.vertical_menu > ul > li > a{
	<?php if (!empty($qode_options_proya['vertical_menu_color'])) { ?> color: <?php echo $qode_options_proya['vertical_menu_color'];  ?>; <?php } ?>
	<?php if($qode_options_proya['vertical_menu_google_fonts'] != "-1"){ ?>
...
<?php if(!empty($qode_options_proya['vertical_dropdown_color']) || !empty($qode_options_proya['vertical_dropdown_fontsize']) || !empty($qode_options_proya['vertical_dropdown_lineheight']) || !empty($qode_options_proya['vertical_dropdown_fontstyle']) || !empty($qode_options_proya['vertical_dropdown_fontweight']) || $qode_options_proya['vertical_dropdown_google_fonts'] != "-1"){ ?>
	...
	<?php if($qode_options_proya['vertical_dropdown_google_fonts'] != "-1"){ ?>
...
<?php if(!empty($qode_options_proya['vertical_dropdown_color_thirdlvl']) || !empty($qode_options_proya['vertical_dropdown_fontsize_thirdlvl']) || !empty($qode_options_proya['vertical_dropdown_lineheight_thirdlvl']) || !empty($qode_options_proya['vertical_dropdown_fontstyle_thirdlvl']) || !empty($qode_options_proya['vertical_dropdown_fontweight_thirdlvl']) || $qode_options_proya['vertical_dropdown_google_fonts_thirdlvl'] != "-1"){ ?>
	...
	<?php if($qode_options_proya['vertical_dropdown_google_fonts_thirdlvl'] != "-1"){ ?>
